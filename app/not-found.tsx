...
export default function NotFound() {
  return (
    <div className="bg-gradient-to-br from-pink-50 to-orange-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
