...
export default function NewArticlePage() {
  ...
  useEffect(() => {
    const fetchAuthors = async () => {
      try {
        // Fetch all users (we'll use the existing users API)
        ...
        if (data.data && Array.isArray(data.data)) {
          ...
          toast.error('Formato de dados inesperado ao carregar autores');
        }
      } catch (err) {
  ...
  const handleTitleChange = (value: string) => {
    ...
    // Generate slug if it hasn't been manually edited
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Erro ao criar artigo';
          ...
          <div className="px-4 lg:px-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground">
                Crie um novo artigo educativo para a plataforma
              </p>
            </div>
          </div>
                  ...
                  <div className="max-h-[calc(100vh-12rem)] overflow-y-auto scrollbar-thin">
                    <div className="max-w-4xl mx-auto p-8">
                      <ArticleHeader
                        ...
                        excerpt={excerpt || 'O resumo do artigo aparecerá aqui. Adicione uma breve descrição que capture a essência do conteúdo.'}
                      ...
                      <ArticleContent 
                        content={content || '<p style="color: var(--muted-foreground);">O conteúdo do artigo aparecerá aqui conforme você digita no editor...</p>'}
                        className="mt-8"
                      />
                    </div>
                  </div>
