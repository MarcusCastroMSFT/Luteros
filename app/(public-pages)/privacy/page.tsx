      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8 space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-gray-800">Informações Fornecidas Voluntariamente:</h3>
              ...
              <h3 className="text-lg font-medium text-gray-800">Informações Coletadas Automaticamente:</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-gray-800">Medidas de Segurança Implementadas:</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <h3 className="text-lg font-medium text-gray-800">Medidas Especiais para Conteúdo Sensível:</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <h3 className="text-lg font-medium text-gray-800">Tipos de Cookies:</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
