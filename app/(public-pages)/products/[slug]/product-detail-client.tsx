      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center space-x-2 text-sm">
            <Link href="/" className="text-gray-500 hover:text-gray-900 cursor-pointer">
              Home
            </Link>
            <ChevronRight size={16} className="text-gray-400" />
            <Link href="/products" className="text-gray-500 hover:text-gray-900 cursor-pointer">
              Produtos
            </Link>
            <ChevronRight size={16} className="text-gray-400" />
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                {/* Valid Until */}
                {product.validUntil && !isNaN(new Date(product.validUntil).getTime()) && (
                ...
                {/* Usage Stats - only show if there are usages or limits */}
                {(product.usageCount > 0 || product.maxUsages) && (
                    ...
                    {relatedProducts.slice(0, 3).map((relatedProduct) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="font-medium text-gray-900 group-hover:text-brand-600 line-clamp-2 text-sm">
