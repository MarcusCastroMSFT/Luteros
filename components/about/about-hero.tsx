...
export const AboutHero = memo<AboutHeroProps>(function AboutHero({
  ...
  return (
    <section 
      className={`relative bg-gradient-to-br from-cta-highlight via-cta-highlight/95 to-cta-highlight/90 text-white overflow-hidden ${className}`}
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/4 right-1/3 w-20 h-20 bg-white/5 rounded-full" />
      </div>
    </section>
  );
});
