        ...
        <AlertDialogHeader>
          ...
          <div className="rounded-lg bg-yellow-50 dark:bg-yellow-900/20 p-3 mt-3">
            <p className="text-sm text-yellow-800 dark:text-yellow-200">
              <strong>Atenção:</strong> Esta ação não pode ser desfeita. O artigo e todos os
              comentários, curtidas e estatísticas associadas serão permanentemente removidos.
            </p>
          </div>
          {error && (
