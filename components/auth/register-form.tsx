          ...
          <form className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="email"
                type="email"
                placeholder="Marcus.castro@gmail.com"
            ...
            <Button 
              type="submit" 
              className="w-full h-10 bg-cta-highlight hover:bg-cta-highlight/90 text-white font-medium rounded-lg"
            >
              Login
            </Button>
            ...
            <div className="grid grid-cols-3 gap-3">
              <Button variant="outline" type="button" className="h-10 border-gray-200 hover:bg-gray-50">
