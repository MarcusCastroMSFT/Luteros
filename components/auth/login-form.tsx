          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-3 gap-3">
              <Button 
                variant="outline" 
                type="button" 
                className="h-10 border-gray-200 hover:bg-gray-50 cursor-pointer"
                disabled
              ...
              <Button 
                variant="outline" 
                type="button" 
                className="h-10 border-gray-200 hover:bg-gray-50 cursor-not-allowed opacity-50"
                disabled
                title="Meta sign-in coming soon"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  <path
