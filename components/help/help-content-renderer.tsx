      ...
      case 'create-account':
        return (
          <div className="max-w-none text-gray-900 dark:text-gray-100">
            <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 dark:border-blue-400 p-6 rounded-lg mb-8">
              <div className="flex items-start">
                <AlertCircle className="text-blue-600 dark:text-blue-400 mt-1 mr-3 flex-shrink-0" size={20} />
                <div>
                  <h4 className="text-blue-800 dark:text-blue-200 font-medium mb-2">Antes de começar</h4>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">1. Acesse a página de registro</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Clique no botão <strong className="font-semibold text-gray-900 dark:text-gray-100">&ldquo;Registrar&rdquo;</strong> no canto superior direito da página inicial ou acesse diretamente 
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">2. Preencha seus dados básicos</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">Você precisará fornecer as seguintes informações:</p>
            <ul className="list-disc pl-6 space-y-2 mb-6 text-gray-700 dark:text-gray-300">
              <li><strong className="font-semibold text-gray-900 dark:text-gray-100">Nome completo:</strong> Use seu nome real para consultas com especialistas</li>
              <li><strong className="font-semibold text-gray-900 dark:text-gray-100">Email:</strong> Será usado para login e comunicações importantes</li>
              <li><strong className="font-semibold text-gray-900 dark:text-gray-100">Senha segura:</strong> Mínimo 8 caracteres, incluindo letras e números</li>
              <li><strong className="font-semibold text-gray-900 dark:text-gray-100">Data de nascimento:</strong> Para verificar se você tem mais de 18 anos</li>
            </ul>

            <div className="bg-green-50 dark:bg-green-900/30 border-l-4 border-green-500 dark:border-green-400 p-6 rounded-lg my-6">
              <div className="flex items-start">
                <CheckCircle className="text-green-600 dark:text-green-400 mt-1 mr-3 flex-shrink-0" size={20} />
                <div>
                  <h4 className="text-green-800 dark:text-green-200 font-medium mb-2">Dica de segurança</h4>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">3. Aceite os termos e políticas</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">4. Confirme seu email</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">5. Complete seu perfil</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">Próximos passos</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
      ...
      case 'first-steps':
        return (
          <div className="max-w-none text-gray-900 dark:text-gray-100">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">1. Explorando o Dashboard</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Após fazer login, você será direcionado ao seu dashboard pessoal, onde encontrará:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-6 text-gray-700 dark:text-gray-300">
              <li><strong className="font-semibold text-gray-900 dark:text-gray-100">Resumo da atividade:</strong> Seus cursos em andamento e consultas agendadas</li>
              <li><strong className="font-semibold text-gray-900 dark:text-gray-100">Recomendações:</strong> Conteúdo personalizado baseado nos seus interesses</li>
              <li><strong className="font-semibold text-gray-900 dark:text-gray-100">Notificações:</strong> Atualizações importantes e lembretes</li>
              <li><strong className="font-semibold text-gray-900 dark:text-gray-100">Progresso:</strong> Acompanhe seu desenvolvimento nos cursos</li>
            </ul>

            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">2. Navegando pelo menu principal</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">O menu principal da Luteros está organizado em seções específicas:</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                <div className="flex items-center mb-4">
                  <BookOpen className="text-cta-highlight mr-3" size={24} />
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100">Cursos</h4>
                </div>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100">Especialistas</h4>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">3. Personalizando sua experiência</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Para aproveitar melhor a plataforma, recomendamos personalizar suas configurações:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-6 text-gray-700 dark:text-gray-300">
              <li>
                <strong className="font-semibold text-gray-900 dark:text-gray-100">Áreas de interesse:</strong> Selecione os temas que mais interessam você para receber 
                conteúdo personalizado
              </li>
              <li>
                <strong className="font-semibold text-gray-900 dark:text-gray-100">Notificações:</strong> Configure como e quando quer receber alertas e lembretes
              </li>
              <li>
                <strong className="font-semibold text-gray-900 dark:text-gray-100">Privacidade:</strong> Defina quem pode ver seu perfil e atividades na comunidade
              </li>
            </ul>

            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">4. Participando da comunidade</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 dark:border-blue-400 p-6 rounded-lg my-6">
              <h4 className="text-blue-800 dark:text-blue-200 font-medium mb-2">Dica importante</h4>
              <p className="text-blue-700 dark:text-blue-300 text-sm mb-0">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">5. Recursos mobile</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">Precisa de ajuda?</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
      ...
      case 'book-consultation':
        return (
          <div className="max-w-none text-gray-900 dark:text-gray-100">
            ...
            <div className="bg-amber-50 dark:bg-amber-900/30 border-l-4 border-amber-500 dark:border-amber-400 p-6 rounded-lg mb-8">
              <h4 className="text-amber-800 dark:text-amber-200 font-medium mb-2">Importante saber</h4>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mt-8 mb-4">1. Escolhendo o especialista</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Acesse a seção <strong className="font-semibold text-gray-900 dark:text-gray-100">&ldquo;Especialistas&rdquo;</strong> no menu principal. Lá você encontrará:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-6 text-gray-700 dark:text-gray-300">
              <li><strong className="font-semibold text-gray-900 dark:text-gray-100">Perfis detalhados:</strong> Formação, especialidades e experiência</li>
              <li><strong className="font-semibold text-gray-900 dark:text-gray-100">Avaliações:</strong> Feedback de outros usuários</li>
              <li><strong className="font-semibold text-gray-900 dark:text-gray-100">Disponibilidade:</strong> Horários livres em tempo real</li>
      ...
      default:
        return (
          <div className="max-w-none text-gray-900 dark:text-gray-100">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 dark:border-blue-400 p-6 rounded-lg mb-8">
              <h4 className="text-blue-800 dark:text-blue-200 font-medium mb-2">Em breve</h4>
              <p className="text-blue-700 dark:text-blue-300 text-sm mb-0">
